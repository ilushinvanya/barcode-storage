...
<template>
    <div ref="containerRef" class="min-h-screen bg-gray-50 relative">
        ...
        <div class="bg-white shadow-sm border-b border-gray-200 sticky top-0 z-10">
            <div class="w-full max-w-[600px] mx-auto px-4 py-4 flex items-center justify-between">
				<div class="flex items-center gap-3">
					<a
						:href="README_URL"
						target="_blank"
						rel="noopener noreferrer"
						class="text-gray-600 hover:bg-gray-100 rounded-lg transition"
				...
				<button
					@click="emit('create')"
					class="p-2 px-4 bg-blue-500 hover:bg-blue-600 text-white rounded-lg transition flex"
					title="Назад"
				>
					+ Создать
				</button>
